...
if (isset($_POST["btnsubmit"])) {
    ...
    $newCategory = new Category($category_id,$name, $status, $created_at);
    $result = $newCategory->createCategory();
    if (!$result) {
        ...
        <div class="content-header row">
            ...
            <?php
                if (isset($_GET["inserted"])) {
                    echo "<h2>Thêm danh mục thành công</h2>";
                } else if (isset($_GET["failure"])) {
                echo "<h2>Thêm danh mục thất bại</h2>";
                }
            ?>
